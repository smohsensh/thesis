...
for data in [1,2,3,4]:
	...
	cluster_file = '/home/mohsen/works/data/zsl/comp/clusters/' + data_sets[data-1] + '.npy'
	...
	res_file = open('/home/mohsen/Dropbox/backup/' + data_sets[data-1] + '_min_nearts+cluster.csv', 'w')
