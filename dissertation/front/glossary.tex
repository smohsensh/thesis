...
\newword{RecommenderSystem}{Recommender System}{سامانه‌ توصیه‌گر}
{سامانه‌های توصیه‌گر}
\newword{onehot}{One-Hot Encoding}{کدگذاری یکی‌یک}{}
\newword{attributePrediction}{attribute prediction}{پیش‌بینی ویژگی}{}
\newword{logisticRegression}{Logistic Regression}{رگرسیون محاسبه‌ای}{}
\newword{dap}{Direct Attribute Prediction}{پیش‌بینی ویژگی مستقیم}{}
\newword{iap}{indirect Attribute Prediction}{پیش‌بینی ویژگی غیرمستقیم}{}
\newword{topicmodel}{Topic Modeling}{مدل‌سازی موضوع}{}
\newword{baysenet}{Baysian Network}{ یک شبکه بیزی}{}
...
\newacronym{COSTA}{COSTA}{Co-Occurance Statistics}
